...
export default function PlaygroundPage() {
  ...
  return (
    <div
      className="eikon-landing relative flex flex-col gap-y-4 px-4 pb-6 sm:px-6 lg:h-[var(--eikon-pg-fill)] lg:flex-row lg:gap-y-0 lg:overflow-hidden lg:pb-0 lg:pl-0"
      style={{
